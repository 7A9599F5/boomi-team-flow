...
This phase creates the connection and operation components that all integration processes depend on. There are 2 connections and 27 operations total (20 HTTP Client + 7 DataHub).
