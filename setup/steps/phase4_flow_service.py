...
class CreateFlowService(BaseStep):
    """Guide user through creating the Flow Service component with all 21 message actions."""
    ...
    def execute(self, state: SetupState, dry_run: bool = False) -> StepStatus:
        ...
        if dry_run:
            ui.print_info("Would guide user to create Flow Service with 21 message actions.")
        ...
        guide_and_wait(
            ...
            "3. Add all 21 message actions listed above\n"
