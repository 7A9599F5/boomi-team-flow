...
- **Current component counts** (verify before editing): 135 total — 5 models, 2 connections, 28 HTTP ops, 12 DH ops, 42 profiles, 20 processes, 21 FSS ops, 1 Flow Service, 2 custom components, 1 Flow connector, 1 Flow app, 11 scripts, 28 API request templates
